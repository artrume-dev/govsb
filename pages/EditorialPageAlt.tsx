...
import { Moon, Sun, ChartNoAxesGantt, Menu, X, Target, Eye, TrendingUp, Award } from 'lucide-react';
import { Button } from '../ui/button';
import { Input } from '../ui/input';

interface EditorialPageAltProps {
  onNavigate?: (page: string) => void;
}

export function EditorialPageAlt({ onNavigate }: EditorialPageAltProps) {
      ...
      <section className="max-w-[90%] mx-auto items-center px-4 lg:px-[5rem] mb-4 mt-12 relative">
        ...
        <div className="relative z-10 py-16 top-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h1 className="font-inter text-5xl md:text-7xl font-normal text-slate-950 dark:text-slate-100">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="py-12 mb-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-space-mono font-bold text-[40px] leading-[1.3] text-slate-950 dark:text-white mb-8">
                The VISIBI Story
              </h2>
              <div className="space-y-6 font-space-mono text-[18px] leading-[1.5] text-slate-950 dark:text-gray-200">
                <p>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="border border-slate-300 dark:border-gray-700 rounded-xl p-8 bg-white dark:bg-slate-900/50">
                  ...
                  <h3 className="font-space-mono font-bold text-[32px] leading-[1.3] text-slate-950 dark:text-white mb-4">
                    Our Mission
                  </h3>
                  <p className="font-space-mono text-[16px] leading-[1.5] text-slate-950 dark:text-gray-300">
          ...
          <section className="py-12 mb-12">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="font-space-mono font-bold text-[40px] leading-[1.3] text-slate-950 dark:text-white mb-4">
                  The VISIBI Framework
                </h2>
                <p className="font-space-mono text-[16px] leading-[1.5] text-slate-950 dark:text-gray-300 max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white dark:bg-slate-900/50 border border-slate-300 dark:border-gray-700 rounded-xl p-8 text-center">
                  ...
                  <h3 className="font-space-mono font-bold text-[24px] leading-[1.3] text-slate-950 dark:text-white mb-3">
                    Authority First
                  </h3>
                  <p className="font-space-mono text-[16px] leading-[1.5] text-slate-950 dark:text-gray-300">
          ...
          <section className="py-12 mb-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-space-mono font-bold text-[40px] leading-[1.3] text-slate-950 dark:text-white mb-8 text-center">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-slate-900/50 border border-slate-300 dark:border-gray-700 rounded-xl p-6">
                  <h3 className="font-space-mono font-bold text-[20px] leading-[1.3] text-slate-950 dark:text-white mb-3">
                    20+ Years in Search
                  </h3>
                  <p className="font-space-mono text-[16px] leading-[1.5] text-slate-950 dark:text-gray-300">
          ...
          <section className="py-12">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <h2 className="font-space-mono font-bold text-[40px] leading-[1.3] text-slate-950 dark:text-white">
                Let's Build Your AI Visibility Strategy
              </h2>
              <p className="font-space-mono text-[18px] leading-[1.5] text-slate-950 dark:text-gray-300">
