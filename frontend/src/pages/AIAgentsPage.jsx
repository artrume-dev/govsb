...
export default function AIAgentsPage() {
  ...
  return (
    <div className="min-h-screen relative line-pattern">
      ...
      {/* Main Content */}
      <main className="max-w-full md:max-w-[90%] mx-auto px-12 py-12 relative z-10 bg-white rounded-xl rounded-tl-none rounded-tr-none rounded-bl-none rounded-br-none border-t border-r border-l border-slate-300 mb-0.5">
